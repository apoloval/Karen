...
class ImageBlendingTest : public utils::UnitTestSuite
{
public:

   ImageBlendingTest() : utils::UnitTestSuite("Image blending")
   {
...
class FontRenderTest : public utils::UnitTestSuite
{
public:

   FontRenderTest() : utils::UnitTestSuite("Font render provider")
   {
   }
...
{
   utils::StdOutUnitTestReporter rep;
   {
