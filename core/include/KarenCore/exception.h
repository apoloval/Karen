...
#ifndef KAREN_CORE_EXCEPTION_H
#define KAREN_CORE_EXCEPTION_H
...
#define KAREN_DECL_EXCEPTION(classname) \
   class KAREN_EXPORT classname : public karen::Exception { \
   public:\
      classname(const String& cause, const String& file, long line) \
        : karen::Exception(cause, file, line) {}\
      \
      classname(const String& cause, const String& file, \
                long line, karen::Exception* nestedException) \
        : karen::Exception(cause, file, line, nestedException) {}\
      \
   }
