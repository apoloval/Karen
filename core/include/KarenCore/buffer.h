...
#ifndef KAREN_CORE_BUFFER_H
#define KAREN_CORE_BUFFER_H
...
public:
   ...
   void copyFromBuffer(
         ...
         unsigned long dstOffset = 0) throw (OutOfBoundsException);
    ...
    */
   template <class T> 
   const T& get(unsigned long offset) const throw (OutOfBoundsException)
   {
